...
Alboarrd is a fast, stateless service hub for your homelab, showing the users the services they can access.<img src="resources/dashboard.gif"/>
...
2. **Environment variables**\
   You can control which HTTP header fields are accessed by tweaking the environment variables:
   | variable | description | default |
   | --------------- | -------------------------------------------------------------------------- | -------------- |
   | `HEADER_USER` | header field containing the username | `remote-user` |
   | `HEADER_NAME` | header field containing the full name of the user | `remote-name` |
   | `HEADER_GROUPS` | header field containing comma-separated list of groups the user belongs to | `remote-group` |
